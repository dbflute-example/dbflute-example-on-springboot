<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:redirect="org.apache.xalan.lib.Redirect"
                ...
                <table border="0" width="100%">
                    <tr>
                        <td style="text-align: justify;">
                            ...
                            reported with a reference to the <a href="http://java.sun.com/docs/books/jls/second_edition/html/jTOC.doc.html">
                            Java Language Specifications
                        </a> (JLS x.x.x)
                            and Metamata Audit rules (x.x).
                            Please consult these documents for additional information about violations.
                            <p/>
                            Rules checked also enforce adherence to <a href="http://java.sun.com/docs/codeconv/html/CodeConvTOC.doc.html">
                ...
                <table class="log" border="0" cellpadding="5" cellspacing="2" width="100%">
                    ...
                    <xsl:for-each select="class[not(./@package = preceding-sibling::class/@package)]">
                        ...
                        <tr>
                            ...
                            <td>
                                <xsl:value-of select="sum(/classes/class[./@package = current()/@package]/@violations)"/>
                            </td>
                        </tr>
                    </xsl:for-each>
                </table>
    ...
    <xsl:template name="pageHeader">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td style="text-align:right">Designed for use with <a href='http://www.webgain.com/products/quality_analyzer/'>Webgain
                    QA/Metamata Audit
