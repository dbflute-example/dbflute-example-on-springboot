...
import org.dbflute.svflute.web.controller.exception.WrongUrlChainUseException;
...
public class UrlChain {
     ...
     * The name and specification of this method is synchronized with {@link BrRootAction#moreUrl()}.
     ...
     * The name and specification of this method is synchronized with {@link BrRootAction#params()}.
     ...
     * The name and specification of this method is synchronized with {@link BrRootAction#hash()}.
