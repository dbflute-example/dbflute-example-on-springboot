 ...
 */
package org.docksidestage.springboot.dbflute.bsbhv;
...
import org.docksidestage.springboot.dbflute.bsbhv.loader.*;
import org.docksidestage.springboot.dbflute.exentity.*;
import org.docksidestage.springboot.dbflute.bsentity.dbmeta.*;
...
public abstract class BsMemberFollowingBhv extends AbstractBehaviorWritable<MemberFollowing, MemberFollowingCB> {
     ...
     * MemberFollowingCB cb = new MemberFollowingCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;MemberFollowingCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;MemberFollowingCB&gt;();
     * option.self(new SpecifyQuery&lt;MemberFollowingCB&gt;() {
     *     public void specify(MemberFollowingCB cb) {
