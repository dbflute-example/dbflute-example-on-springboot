 ...
 */
package org.docksidestage.springboot.dbflute.cbean.bs;
...
import org.docksidestage.springboot.dbflute.allcommon.DBFluteConfig;
import org.docksidestage.springboot.dbflute.allcommon.DBMetaInstanceHandler;
import org.docksidestage.springboot.dbflute.allcommon.ImplementedInvokerAssistant;
import org.docksidestage.springboot.dbflute.allcommon.ImplementedSqlClauseCreator;
...
public class BsMemberCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
        ...
        public HpSDRFunction<MemberFollowingCB, MemberCQ> derivedMemberFollowingByMyMemberId() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (fn, sq, cq, al, op) -> cq.xsderiveMemberFollowingByMyMemberIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from member_following where ...) as FOO_MAX} <br>
        ...
        public HpSDRFunction<MemberFollowingCB, MemberCQ> derivedMemberFollowingByYourMemberId() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (fn, sq, cq, al, op) -> cq.xsderiveMemberFollowingByYourMemberIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
