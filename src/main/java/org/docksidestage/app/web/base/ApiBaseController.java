...
public class ApiBaseController {
     ...
     * @return The framework-handling entity of response for client error. (NotNull)
     */
    public ResponseEntity<ApiErrorResponse> clientError() {
     ...
     * ユーザの入力不備などリトライすれば
     * @param result The binding result containing errors information. (NotNull)
     * @return The framework-handling entity of response for client error. (NotNull)
     */
    public ResponseEntity<ApiErrorResponse> validationError(BindingResult result) {
        ApiErrorResponse errors = new ApiErrorResponse();
